...
export function getPageContent(isPt) {
  return {
    ...
    ui: {
      ...
      academicText: isPt
        ? "Sou professor de História e Letramento Digital, graduado pela Universidade Federal do Rio Grande do Norte (UFRN). Tenho mestrado em Antropologia pela Universidade Federal da Paraíba (PPGA/UFPB) e em Inovação em Tecnologias Educacionais pelo PPgITE/IMD/UFRN, programa no qual atualmente desenvolvo minha pesquisa de doutorado. Realizo doutorado sanduíche como Visiting Research Student na Faculty of Arts, no Department of Classics and Ancient History, e no Bristol Digital Game Lab (BDGL), da University of Bristol, no Reino Unido. Também sou especialista em Metodologias Ativas pela Faculdade FABRAS. Atuo como professor-pesquisador na educação básica, desenvolvendo experiências de aprendizagem que articulam tecnologias imersivas, jogos digitais, metodologias ativas e ensino de História. Minha pesquisa investiga como experiências imersivas em Realidade Virtual podem representar o passado e quais potencialidades e limites apresentam para a interpretação histórica de estudantes, com especial atenção aos passados sensíveis, isto é, eventos marcados por violência, trauma e disputas de memória. Também atuo como palestrante, facilitador de oficinas e consultor educacional, na condição de Apple Professional Learning Specialist, além de produzir conteúdos sobre inovação educacional, XR e jogos digitais no Instagram (@prof.LucasVale). Meus interesses de pesquisa incluem Ensino de História, Realidade Virtual, Experiências Imersivas, Passados Sensíveis, Humanidades Digitais e Jogos Educacionais."
  : "I am a History and Digital Literacy teacher, graduated from the Federal University of Rio Grande do Norte (UFRN). I hold a Master’s degree in Anthropology from the Federal University of Paraíba (PPGA/UFPB) and a Master’s degree in Innovation in Educational Technologies from PPgITE/IMD/UFRN, where I am currently developing my PhD research. I am undertaking a sandwich PhD as a Visiting Research Student at the Faculty of Arts, Department of Classics and Ancient History, and at the Bristol Digital Game Lab (BDGL), University of Bristol, United Kingdom. I also hold a specialization in Active Learning Methodologies from Faculdade FABRAS. I work as a teacher-researcher in basic education, developing learning experiences that articulate immersive technologies, digital games, active learning methodologies, and History education. My research investigates how immersive Virtual Reality experiences can represent the past and what possibilities and limits they present for students’ historical interpretation, with particular attention to sensitive pasts, that is, events marked by violence, trauma, and disputes over memory. I also work as a speaker, workshop facilitator, and educational consultant as an Apple Professional Learning Specialist, and produce content on educational innovation, XR, and digital games on Instagram (@prof.LucasVale). My research interests include History Education, Virtual Reality, Immersive Experiences, Sensitive Pasts, Digital Humanities, and Educational Games.",
